...
Route::get('/', function() {
    ...
    return view('home')->with('darkThemeFlag', false)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-newsE', function() { 
    ...
    return view('newsE')->with('darkThemeFlag', true)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/contact', function() {
    ...
    return view('contact')->with('darkThemeFlag', true)->with('bodyClass', 'contact')->with('name', 'SOCIAL')->with('description', $description)->with('links', $links)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/about', function() {
    ...
    return view('about')->with('darkThemeFlag', true)->with('bodyClass', 'about')->with('name', 'US')->with('description', $description)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);                   
});
...
Route::get('/the-kingdom2', function() {
    ...
    return view('kingdom2')->with('darkThemeFlag', true)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-flora2', function() {
    ...
    return view('flora2')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-flora3', function() {
    ...
    return view('flora3')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-flora4', function() {
    ...
    return view('flora4')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-flora5', function() {
    ...
    return view('flora5')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/laws/1995', function() {
    ...
    return view('components.yearly-story')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('bodyClass', 'the-laws-1')->with('year', $year)->with('subtext', $subtext)->with('story', $story)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-kingdom', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-kingdom')->with('name', 'KINGDOM')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-flora', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-flora')->with('name', 'FLORA')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-fauna', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-fauna')->with('name', 'FAUNA')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-mammals', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-mammals')->with('name', 'Mammals')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-mammals2', function() {
    ...
    return view('mammals2')->with('darkThemeFlag', true)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-birds', function() {
    ...
    return view('story')->with('darkThemeFlag', false)->with('bodyClass', 'the-birds')->with('name', 'Birds')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-birds2', function() {
    ...
    return view('birds2')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-butterfly2', function() {
    ...
    return view('butterfly2')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-park', function() {
    ...
    return view('park')->with('darkThemeFlag', false)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-climate', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-climate')->with('name', 'CLIMATE')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-summer', function() {
    ...
    return view('summer')->with('darkThemeFlag', true)->with('bodyClass', 'the-summer')->with('name', 'SUMMER')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-winter', function() {
    ...
    return view('winter')->with('darkThemeFlag', false)->with('bodyClass', 'the-winter')->with('name', 'WINTER')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-spring', function() {
    ...
    return view('spring')->with('darkThemeFlag', false)->with('bodyClass', 'the-spring')->with('name', 'SPRING')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-autumn', function() {
    ...
    return view('autumn')->with('darkThemeFlag', true)->with('bodyClass', 'the-autumn')->with('name', 'AUTUMN')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-change', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-change')->with('name', 'CHANGE')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
Route::get('/the-change2', function() {
    ...
    return view('change2')->with('darkThemeFlag', true)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-laws', function() {
    ...
    return view('story')->with('darkThemeFlag', false)->with('bodyClass', 'the-laws')->with('name', 'LAWS')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-people', function() {
    ...
    return view('story')->with('darkThemeFlag', true)->with('bodyClass', 'the-people')->with('name', 'PEOPLE')->with('description', $description)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});
...
Route::get('/the-people2', function() {
    ...
    return view('people2')->with('darkThemeFlag', true)->with('links', $links)->with('nextLink', $nextLink)->with('cnavBg', $cnavBg)->with('cnavInnerBorder', $cnavInnerBorder);
});

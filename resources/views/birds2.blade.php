...
<section class="story-section gallery-wrapper">
    <div class="gallery-container">
        ...
        <div class="option" style="background: white">
            ...
            <div class="description">
                    <div class="image-content text-black scroll">Black-necked storks are large in size and has a white lower breast and belly. Its bill and legs are red in colour. They have a black beak, black head, and black neck. Found in tropical wetlands and ponds. It have been recorded for the first time in Wangchuck Centennial National Park (WCNP) in Bumthang.</div>
            </div>
        </div>
        ...
        <div class="option" style="background: white">
            ...
            <div class="description">
                    <div class="image-content text-black scroll">The great hornbill has a large, curved yellow beak. Its black face and wings contrast its white tail, belly, and neck. It is found in undisturbed evergreen forest at up to 2,000 metres. It was found in Royal Manas Park.</div>
            </div>
        </div>
        ...
        <div class="option" style="background: white">
            ...
            <div class="description">
                    <div class="image-content text-black scroll">These are large shorebirds with a brown body, a long curved beak, and mostly white underwings. You may find them in grasslands and marshes. It was found around Punatsangchu and Wangdue Phodrang.</div>
            </div>
        </div>

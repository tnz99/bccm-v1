...
<section class="story-section">
    <div class="gallery-container">
        <div class="options">
            ...
            <div class="option" style="background: #0E4A47; opacity: 0.7;">
                <div class="image" style="background-image: url('../images/backgrounds/p1.jpg');">
                    <div class="label">
                        <div class="info">
                            <div class="main">𝐂𝐥𝐢𝐦𝐚𝐭𝐞 𝐜𝐡𝐚𝐧𝐠𝐞 𝐚𝐧𝐝 𝐢𝐭𝐬 𝐢𝐦𝐩𝐚𝐜𝐭𝐬 𝐨𝐧 𝐦𝐢𝐠𝐫𝐚𝐭𝐢𝐨𝐧 𝐩𝐚𝐭𝐭𝐞𝐫𝐧 𝐚𝐦𝐨𝐧𝐠 𝐡𝐢𝐠𝐡𝐥𝐚𝐧𝐝𝐞𝐫𝐬: Denkars Getaway</div>
            ...
            <div class="option" style="background: #0E4A47; opacity: 0.7;">
                ...
                <div class="description">
                    <div class="image-content scroll text-white">
                    In Bhutanese towns and villages, individuals are embracing sustainable lifestyles. From using energy-efficient appliances to practicing mindful consumption, the people of Bhutan understand that small, everyday choices collectively contribute to a carbon-neutral lifestyle. Moreover, communities actively engage in tree planting initiatives, turning barren areas into green spaces that act as carbon sinks and contribute to overall environmental health.
            ...
            <div class="option" style="background: #0E4A47; opacity: 0.7;">
                <div class="image" style="background-image: url('../images/backgrounds/p2.jpg');">
                    <div class="label">
                        <div class="info">
                            <div class="main">Jamyang's Climate Crusade: Spreading Awareness Across Bhutan</div>
            ...
            <div class="option" style="background: #0E4A47; opacity: 0.7;">
                <div class="image" style="background-image: url('../images/backgrounds/l2.avif');">
                    <div class="label">
                        <div class="info">
                            <div class="main">Bhutan’s tree warrior: Spreading life in the world’s most climate conscious nation</div>
                ...
                <div class="description">
                    <div class="image-content scroll text-white">
                    In Thimphu, Bhutan's capital, Sonam Phuntsho, a retired Bhutanese man, exemplifies the nation's commitment to environmental protection. For over 50 years, Sonam has dedicated himself to planting trees, covering 10 kilometers daily to rejuvenate degraded forest areas.

His commitment is extraordinary; with each step, he carries saplings and purpose. Sonam's efforts have transformed neglected spaces into thriving green havens. Over his lifetime, he planted 100,000 trees, a testament to his unwavering dedication.

Sonam embodies Bhutan's dedication to preserving its natural heritage. The constitutional mandate, requiring 60% forest cover, is a way of life embraced by individuals like him. His remarkable story symbolizes Bhutanese commitment to a green and sustainable future.
            ...
            <div class="option" style="background: #0E4A47; opacity: 0.7;">
                <div class="image" style="background-image: url('../images/backgrounds/p4.jpg');">
                    <div class="label">
                        <div class="info">
                            <div class="main">Former PM Tshering Tobgay’s talk on Bhutan's Pioneering Efforts in Climate Change Mitigation.</div>
            ...
            <div class="option" style="background: #0E4A47; opacity: 0.7;">
                <div class="image" style="background-image: url('../images/backgrounds/p3.jpg');">
                    <div class="label">
                        <div class="info">
                            <!-- <div class="main">Namgay Choden's Impact as a Climate Advocate and Leader in Bhutan</div> -->
